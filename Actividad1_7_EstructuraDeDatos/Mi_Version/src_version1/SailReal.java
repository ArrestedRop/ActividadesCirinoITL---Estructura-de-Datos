...
public class SailReal {
    ...
    public static void main(String[] args) {
        ...
        do {
            try {
                String seleccion = JOptionPane.showInputDialog(null, menu, "SAIL 5.0", JOptionPane.QUESTION_MESSAGE);
    ...
    public static void imprimirIndividual(int pos, String nombre, Persona[] grupo) {
        if (pos != -1) {
            ...
            JOptionPane.showMessageDialog(null, "No se encontró a: " + nombre, "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
